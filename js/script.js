...
openModal('.button2', '.modal[data-modal="one"]') // Запускаем функцию и передаем селекторы для модального окна первой кнопки "записаться"
openModal('.button3', '.modal[data-modal="two"]') // Запускаем функцию и передаем селекторы для модального окна второй кнопки "записаться"
openModal('.button4', '.modal[data-modal="two"]') // Запускаем функцию и передаем селекторы для второго модального окна
